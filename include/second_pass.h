 ...
 * references, genrating complete machine code, and preparing data for
 ...
 *
 * Allocates and initialzies all nexessary data structures for the assembly
 * process.
 *
 ...
 *
 * Releases all memory allocated for the assembly context inluding:
 * - Instruction image.
 * - Entry list.
 * - External list.
 *
